...
*NaturePHP* : <a href="http://naturephp.org" title="Open source auto-loaded library system for php">http://naturephp.org</a>
...
<li>3: Included classes (Quick Documentation)
	<ul>
...
<li>Use [ @include('nphp/init.php');@ ] to include NaturePHP's autoloader into you site/app instance.
...
<li>*Checking if you are on a NaturePhp enviornment //*

...
* Path::setBase() now fully working, great for auto-path corrections for ajax calls.
* Database now supports MSSQL (mssql PHP extension) and SQLite 2.0.
* Mail class improvements.
* Added some usage examples (check folder exmples/).
